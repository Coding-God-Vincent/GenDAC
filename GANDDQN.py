    ...
    for i in range(len(seeds)):
        ...
        class WGAN_GP_Agent(object):
            ...
            def save_w(self):
                ...
                # 存下訓練好的參數以供後續產圖
                if fixed_UE:
                    torch.save(self.G_model.state_dict(), '/home/super_trumpet/NCKU/Paper/My Methodology/Params/fixed_UE/6_algos/GANDDQN/Generator_weights.pth')
                    torch.save(self.D_model.state_dict(), '/home/super_trumpet/NCKU/Paper/My Methodology/Params/fixed_UE/6_algos/GANDDQN/Discriminator_weights.pth')
                else:
                    torch.save(self.G_model.state_dict(), '/home/super_trumpet/NCKU/Paper/My Methodology/Params/movingUE/6_algos/GANDDQN/Generator_weights.pth')
                    torch.save(self.D_model.state_dict(), '/home/super_trumpet/NCKU/Paper/My Methodology/Params/movingUE/6_algos/GANDDQN/Discriminator_weights.pth')
