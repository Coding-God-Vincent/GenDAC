...
exps_0005 = ['exp276', 'exp277', 'exp278', 'exp279', 'exp280']
exps_0001 = ['exp281', 'exp282', 'exp283', 'exp284', 'exp285']
...
for lam in lam_end:
    ...
    if lam == 0.5: exps = exps_05
    elif lam == 0.05: exps = exps_005
    elif lam == 0.01: exps = exps_001
    elif lam == 0.005: exps = exps_0005
    else: exps = exps_0001
