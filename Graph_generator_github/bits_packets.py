...
algo_name2 = "GenDAC_packet"


algo_names = [algo_name1, algo_name2]
labels = ["packet bits", "No of packets"]
...
if fixed: image_path = Path(f"/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_fixedUE_env/Combine/{Figure}/max_action_3/Test/state")
else: image_path = Path(f"/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_movingUE_env/Combine/{Figure}/max_action_3/Test/state")
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
'''Utility'''
