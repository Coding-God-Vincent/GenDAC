...
for fixed in fixed_or_not:
    ...
    if fixed: 
        csv_path = Path("/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_fixedUE_env/Combine/CSVs") / f"seed_{seeds[0]}"
        image_path = Path("/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_fixedUE_env/Combine/Figures_3_v2/max_action_3/others/Proportion")
    else: 
        csv_path = Path("/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_movingUE_env/Combine/CSVs") / f"seed_{seeds[0]}"
        image_path = Path("/home/super_trumpet/NCKU/Paper/My Methodology/Outcomes/Outcome_movingUE_env/Combine/Figures_3_v2/max_action_3/others/Proportion")

    if fixed: algo_name1 = "GenDAC_DDPM_3"
    else: algo_name1 = "GenDAC_different_speed"
    algo_name2 = "GANDDQN_200khz"
    algo_name3 = "LSTM_A2C"
    algo_name4 = "PPO_different_speed"
    algo_name5 = "SAC"
    # algo_names = [algo_name1, algo_name3, algo_name4, algo_name5]
    algo_names = [algo_name2]
