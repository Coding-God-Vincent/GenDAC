...
lambdas = [1, 0.5, 0.001, 0]


seeds = [124, 125, 126, 127, 128]

exps_1 = ['exp345', 'exp346', 'exp347', 'exp348', 'exp349']
exps_05 = ['exp350', 'exp351', 'exp352', 'exp353', 'exp354']
exps_0001 = ['exp355', 'exp356', 'exp357', 'exp358', 'exp359']
exps_0 = ['exp360', 'exp361', 'exp362', 'exp363', 'exp364']
...
for lam in lambdas:
    ...
    elif lam == 0.5: exps = exps_05
    elif lam == 0.001: exps = exps_0001
    else: exps = exps_0
