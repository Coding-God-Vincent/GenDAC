...
# hyperparameters
fixed_UE = False
exps_5 = ['exp239', 'exp240']
exps_7 = ['exp241', 'exp242', 'exp243', 'exp244', 'exp245']
steps = [5, 7]
seeds2 = [127, 128]
seeds1 = [124, 125, 126, 127, 128]
hard_scenario = False
DDIM = False
...
for step in steps:
    ...
    for i in range(len(seeds)):
        ...
        else: env = EnvMove(UE_max_no= UE_no, ser_prob= np.array([1, 2, 3], dtype= np.float32), learning_windows= learning_windows, dl_mimo= dl_mimo, hard_scenario= hard_scenario, schedu_method= 'round_robin_reuse_rem')
